...
// Fork policy (FORK.md) ships only English and Traditional Chinese; upstream's other six
// locale copies of docs-site do not exist in this tree, so only those two are checked here.
const GUIDES = [
