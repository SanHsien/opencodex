> This is the [SanHsien/opencodex](https://github.com/SanHsien/opencodex) maintenance fork. Product behavior follows upstream v2.48.0; see [FORK.md](FORK.md) for maintenance policy.
