...
// Fork policy (FORK.md) ships only English and Traditional Chinese, matching
// docs-site/astro.config.mjs's locale list; upstream's other six locale copies do not exist
// in this tree.
const GUIDES = [
