 ...
 */
// Fork policy (FORK.md) ships only English and Traditional Chinese; the "en" page is
// README.en.md (root README.md is the fork's own Traditional Chinese overlay, not a mirror of
// this technical section) and upstream's other six locale README copies do not exist here.
const PAGES = [
  {
    locale: "en",
    path: "README.en.md",
